                    ...
                    child: DottedBorder(
                        ...
                        child: Container(
                            ...
                            child: Center(
                                child: IconButton(
                              onPressed: () async {
                                await context.read<MainCubit>().pickFile().then((value) => context.read<MainCubit>().userInputs[fieldName??''] =
                                    // files ?? []
                      ...
                      Positioned(
                          ...
                          child: IconButton(
                            onPressed: () {
                              ...
                              context.read<MainCubit>().userInputs[fieldName??''] = files?.map((e) => File(e.path!)).toList();
                            },
                            icon: CircleAvatar(
