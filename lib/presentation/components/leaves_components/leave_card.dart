        ...
        children: [
          Column(
            children: [
              ...
              LeaveListTile(icon: Icons.note_alt_outlined,title: 'Notes',subtitle: leave.notes ?? 'no Notes',color: Colors.blueAccent.withOpacity(0.2),),
          ...
          Align(
            ...
            child: IconButton(onPressed: (){},icon: Icon(Icons.edit_outlined,color: AppColors.grey,size: 24.w,),),
          )
        ],
      ),
    );
