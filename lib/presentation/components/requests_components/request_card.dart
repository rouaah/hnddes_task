...
class RequsetCard extends StatelessWidget {
  const RequsetCard({super.key,this.isRejected = false});
                ...
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        LabelText(labelText: 'common.service'.tr(context)+': maintainance',),
                        SizedBox(height: 8.h,),
                        LabelText(labelText: 'common.id'.tr(context) + ': 123456',),
                        SizedBox(height: 8.h,),
                        LabelText(labelText: 'common.date'.tr(context)+': 12-9-2023',),
                      ],
                    ),
                  ],
                ),
