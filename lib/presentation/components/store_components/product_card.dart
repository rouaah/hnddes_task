...
elevation: 2,
 ...
 flex: 1,               child: ClipRRect(
                        ...
                        child:
                        Image.asset('assets/images/uploaded.png',fit: BoxFit.cover,width: 151.w,)),
              ),
              // SizedBox(width: 14.w,),
          Expanded(
            // height: 135.h,
              ...
              child: Column(
                      ...
                      children: [
                        Wrap(
                          ...
                          children: [
                            TitleSubtitleDetail(title: product.prodName, subtitle: 'store.price'.tr(context)+' : ${product.price} IDQ',padding: 4,),
                            FittedBox(fit: BoxFit.cover,child: Text('store.quantity'.tr(context)+' :${product.count}',style: AppTextStyles.title4TextStyle,softWrap: true,overflow: TextOverflow.ellipsis,)),
                          ],
                        ),
                        SizedBox(height: 7.h,),
                        Text( 'store.description'.tr(context),style: AppTextStyles.title3TextStyle),
                        Text(
                          product.prodDesc,
...
await context.read<MainStoreCubit>().addToCart(product);
                },icon: Center(child: Icon(Iconsax.shopping_cart_copy,color: AppColors.primaryColor,size: 24.w,)))
              ))
